...
class Query
{
    ...
    public function cache($key = true, $expire = null, $tag = null)
    {
        ...
        if ($key instanceof \DateTime || (is_numeric($key) && null === $expire)) {
            $expire = $key;
            $key    = true;
        }
